...
import { searchOutline, notificationsOutline, informationCircleOutline, timeOutline } from 'ionicons/icons';
import './HomeTwo.css';
  ...
  return (
    <IonPage style={{ background: '#ffffff' }}>
      <IonContent
        ...
        scrollY={true}
        style={{ '--background': '#ffffff', '--padding-start': '0', '--padding-end': '0' }}
      >
