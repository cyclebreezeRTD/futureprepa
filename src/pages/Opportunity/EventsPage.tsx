            ...
            <div className="events-list">
              ...
              <div className="event-card featured-event">
                ...
                <div className="event-info">
                  <p className="event-date">Sat, Apr 19 · 22:00 PM</p>
                  <h3 className="event-title">La Rosalia</h3>
                  <p className="event-venue">
                    <svg width="12" height="14" viewBox="0 0 12 14" fill="none">
                      <path d="M6 0C2.69 0 0 2.69 0 6c0 4.5 6 8 6 8s6-3.5 6-8c0-3.31-2.69-6-6-6zm0 8c-1.1 0-2-.9-2-2s.9-2 2-2 2 .9 2 2-.9 2-2 2z" fill="#FF4D8F"/>
                    </svg>
                ...
                <div className="event-actions">
                  <button className="action-btn favorite-btn">
                    <svg width="22" height="20" viewBox="0 0 22 20" fill="none">
                      <path d="M11 19l-1.5-1.3C4.4 13.36 1 10.28 1 6.5 1 3.42 3.42 1 6.5 1c1.74 0 3.41.81 4.5 2.09C12.09 1.81 13.76 1 15.5 1 18.58 1 21 3.42 21 6.5c0 3.78-3.4 6.86-8.5 11.2L11 19z" stroke="white" strokeWidth="1.5"/>
                    </svg>
                  </button>
                  <button className="action-btn share-btn">
                    <svg width="18" height="20" viewBox="0 0 18 20" fill="none">
                      <circle cx="3" cy="10" r="2.5" stroke="white" strokeWidth="1.5"/>
                      <circle cx="15" cy="4" r="2.5" stroke="white" strokeWidth="1.5"/>
                      <circle cx="15" cy="16" r="2.5" stroke="white" strokeWidth="1.5"/>
                      <path d="M5.5 9l7-3M5.5 11l7 3" stroke="white" strokeWidth="1.5"/>
                    </svg>
                  </button>
                </div>
              </div>
